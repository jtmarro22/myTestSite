      ...
      select{
        ...
        appearance: menulist;
          ...
          <li> -->
            <!-- <div class="item-content">
              ...
              <div class="item-inner"> 
                ...
                <div class="item-input">
                  <input type="email" name="email" placeholder="Enter Your Friend's E-mail"/>
                </div>
              </div>
            </div>
          </li>
          ...
          <div class="item-content">
              ...
              <div class="item-inner"> 
              <div class="item-input">
                <input type="tel" name="phone" placeholder="Text To Your Friend’s Phone Number" required/>
                </div>
              </div>
              </div>
          </li>

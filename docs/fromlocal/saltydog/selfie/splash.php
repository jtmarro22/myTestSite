...
<div class="pages" style="overflow-y:scroll;z-index:1;">
  ...
  You've been Entered! Good Luck!
   ...
   <div style="position:relative;width:100%;height:100%;text-align:center;color:#fff;font-size:30px;">
        ...
        <?php if($image != ''){?>
          <img src="src/<?php echo $image;?>.jpg" style="width:100%;position:relative;top:0;z-index:9999999;left:0;" />
          <?php }else{?>
          ...
          <?php }?>
          <p id="sentInfo" claas="text-center mb-0 pb-0" style="color:green; font-size: 24px;"> </p>
</div>
          
         
          </div>
          <div style="position:absolute;top:54%;width:100%;">
         <a href="email.php" class="button button-big  active" style="margin-top:10px;">Email Your Photo to Friends</a>
         <a href="text.php" class="button button-big  active" style="margin-top:10px;">Text Your Photo to Friends</a>
...
<div style="width:100%;color:#fff;font-size:14px;text-align:center;padding:10px;"><div style="width:90%;text-align:center;text-align:center;">
    <b>Salty Dog will never store or share your personal info!</b></div></div>

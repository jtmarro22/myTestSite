      ...
      <div class="list-block" style="margin-bottom:20px;margin-top:0;">
        ...
        <ul>
          ...
          <li>
            ...
            <p style="text-align: center; font-size: smaller;">* Seperate each email with a comma.</p>
          </li>
          <li>
          <div class="item-content">
              ...
              <div class="item-inner">
                <div class="item-input">
                  <input type="tel" name="phone" placeholder="Recipient's Phone Number"/>
                </div>
              </div>
            </div>
          <p style="text-align: center; font-size: smaller;">* ATT & Verizon Only. Seperate each number with a comma. </p>
          </li>
          <li class="align-top">
            <div class="item-content">
              ...
              <div class="item-inner"> 
                ...
                <div class="item-input">
                  <textarea name="message" class="message" placeholder="Say Hello Here"></textarea>
                </div>
              </div>
            </div>
          </li>

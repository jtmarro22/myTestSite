...
<div class="pages" style="overflow-y:scroll;z-index:1;">
  ...
  <div id="failed" style="width: 80%;margin: 70px auto;background: rgba(255,255,255,.9);color: #3b3b3b;text-align: center;font-size: 16px;padding: 10px;border-radius: 4px;display: none;position: absolute;z-index: 9999;left: 50%;margin-left: -40%;">
  Failed
  </div>
   ...
   <div style="position:relative;width:100%;height:100%;text-align:center;color:#fff;font-size:30px;">
        ...
        <?php if($image != ''){?>
         ...
         <a href="emailSelfie.php" class="button button-big  active" style="margin-top:10px;">Share Your Photo </a>
         <!-- <a href="emailSelfie.php" class="button button-big  active" style="margin-top:10px;">Email Your Photo </a> -->
...
<div style="width:100%;color:#fff;font-size:10px;text-align:center;padding:10px;"><div style="width:90%;text-align:left;text-align:center;">
    Salty Dog does not store or share your e-mail address.</div></div>

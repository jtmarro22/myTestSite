...
$('#submit').on('click',function(e){
  ...
  $.ajax({
               ...
               {
                $("#success").show();
                $("#sentInfo").text("Your Picture was Successfully Sent");
            $("#success").hide(6000);
               }
             });  
$("#sentInfo").text("Sending...");
mainView.router.back();
});
...
// };
 ...
 myApp.onPageInit('sendEmail', function (page) {
  ...
  // };
   ...
   myApp.onPageInit('text', function (page) {
    document.getElementById("photo").src="https://selfie.saltydog.com/src/image-" + number + ".jpg";
    ...
    $('#submit').on('click',function(e){
      ...
      $.ajax({
                   ...
                   {
                    $("#success").show();
                    $("#sentInfo").text("Your Photo was Successfully Sent");
                $("#success").hide(6000);
                   }
                 });  
      $("#sentInfo").text("Sending...");
